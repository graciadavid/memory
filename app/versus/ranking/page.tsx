...
import VersusRankingClient from './VersusRankingClient'
...
export default async function VersusRankingPage() {
  ...
  return (
    <main style={{
      height: '100dvh',
      background: 'linear-gradient(180deg, #FFEBEE 0%, #FAF7F2 100%)',
      ...
      <div style={{ padding: '24px 16px 12px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          <div style={{ fontSize: 26, fontWeight: 900, color: '#4A2C0A', letterSpacing: -1 }}>Higher or Lower Ranking</div>
        </div>
