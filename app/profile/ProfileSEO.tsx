     ...
     <details style={{ marginBottom: 12, background: 'rgba(255,255,255,0.04)', borderRadius: 14, border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden' }}>
       ...
       <div style={{ padding: '0 16px 16px', fontSize: 14, lineHeight: 1.8, color: 'rgba(255,255,255,0.6)' }}>
         ...
         <p>Memory performance peaks in the mid-twenties and declines gradually with age, but this decline is much slower in people who engage in regular memory training. Research consistently shows that deliberate memory exercise maintains capacity and retrieval speed well into later life.</p>
           <a href="/memory-hub" style={{ display:'flex', alignItems:'center', gap:10, background:'#C6282810', borderRadius:10, padding:'10px 14px', marginTop:12, textDecoration:'none' }}><img src="https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/brain-logo.webp" style={{ width:28, height:28, objectFit:'contain' }} /><span style={{ fontSize:13, fontWeight:900, color:'#C62828' }}>Train Memory →</span></a>
       </div>
     </details>
     ...
     <details style={{ marginBottom: 12, background: 'rgba(255,255,255,0.04)', borderRadius: 14, border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden' }}>
       ...
       <div style={{ padding: '0 16px 16px', fontSize: 14, lineHeight: 1.8, color: 'rgba(255,255,255,0.6)' }}>
         ...
         <p>Unlike many cognitive abilities, reaction time is highly trainable. Elite athletes, surgeons and fighter pilots all demonstrate reaction times significantly faster than average — and research shows this advantage comes from years of deliberate practice, not purely from genetics.</p>
           <a href="/agility" style={{ display:'flex', alignItems:'center', gap:10, background:'#F9A82510', borderRadius:10, padding:'10px 14px', marginTop:12, textDecoration:'none' }}><img src="https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/precision.png" style={{ width:28, height:28, objectFit:'contain' }} /><span style={{ fontSize:13, fontWeight:900, color:'#F9A825' }}>Train Agility →</span></a>
       </div>
     </details>
     ...
     <details style={{ marginBottom: 12, background: 'rgba(255,255,255,0.04)', borderRadius: 14, border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden' }}>
       ...
       <div style={{ padding: '0 16px 16px', fontSize: 14, lineHeight: 1.8, color: 'rgba(255,255,255,0.6)' }}>
         ...
         <p>A strong Knowledge score indicates a broad, well-organised semantic network. People with extensive general knowledge tend to learn new information more quickly because they have more existing connections to attach new facts to — a phenomenon known as the Matthew effect in cognitive science.</p>
           <a href="/knowledge" style={{ display:'flex', alignItems:'center', gap:10, background:'#00796B10', borderRadius:10, padding:'10px 14px', marginTop:12, textDecoration:'none' }}><img src="https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/population.png" style={{ width:28, height:28, objectFit:'contain' }} /><span style={{ fontSize:13, fontWeight:900, color:'#00796B' }}>Train Knowledge →</span></a>
       </div>
     </details>
     ...
     <details style={{ marginBottom: 12, background: 'rgba(255,255,255,0.04)', borderRadius: 14, border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden' }}>
       ...
       <div style={{ padding: '0 16px 16px', fontSize: 14, lineHeight: 1.8, color: 'rgba(255,255,255,0.6)' }}>
         ...
         <p>The good news is that logical reasoning is highly responsive to training. Chess players, mathematicians and programmers consistently show enhanced prefrontal function compared to non-practitioners, and the gains transfer to other domains of reasoning and decision-making.</p>
           <a href="/logic" style={{ display:'flex', alignItems:'center', gap:10, background:'#E6510010', borderRadius:10, padding:'10px 14px', marginTop:12, textDecoration:'none' }}><img src="https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/target.png" style={{ width:28, height:28, objectFit:'contain' }} /><span style={{ fontSize:13, fontWeight:900, color:'#E65100' }}>Train Logic →</span></a>
       </div>
     </details>
