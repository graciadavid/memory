      ...
      <div style={{ maxWidth:430, margin:'0 auto' }}>
        ...
        <div style={{ position:'relative', width:'100%', aspectRatio:'1/1', overflow:'hidden' }}>
          <img
            ...
            alt="MemGenius brain mascot sleeping and consolidating memories"
          ...
          <div style={{ position:'absolute', top:12, right:12, background:'rgba(0,0,0,0.5)', color:'rgba(255,255,255,0.6)', fontSize:10, fontWeight:700, padding:'4px 10px', borderRadius:20 }}>02 / Discover</div>
        </div>
        ...
        <div style={{ padding:'0 16px' }}>
          ...
          <div style={{ fontSize:14, color:'rgba(255,255,255,0.7)', lineHeight:1.8, display:'flex', flexDirection:'column', gap:14 }}>
            ...
            <div style={{ background:'#252525', borderRadius:14, padding:'16px', border:'1px solid rgba(124,58,237,0.25)' }}>
              ...
              <p style={{ fontSize:13, color:'rgba(255,255,255,0.6)', lineHeight:1.7, margin:0 }}>Harvard Medical School researchers found that people who got a full night of sleep after learning a task performed <strong style={{color:'#fff'}}>20–40% better</strong> on tests the next day than those who stayed awake. REM sleep — which dominates the final cycles of the night — was the critical factor.</p>
            ...
            <p>Your sleep runs in <strong style={{color:'#fff'}}>90-minute cycles</strong>. Each cycle ends with a REM phase — the stage where your hippocampus replays the day and transfers memories to the cortex for long-term storage. Wake up mid-cycle and you cut that transfer short.</p>

            {/* QUOTE */}
            <div style={{ borderLeft:'3px solid #a78bfa', paddingLeft:14, background:'rgba(124,58,237,0.05)', borderRadius:'0 10px 10px 0', padding:'12px 14px' }}>
            ...
            <p>Six cycles of 90 minutes equals <strong style={{color:'#fff'}}>9 hours</strong>. But even <strong style={{color:'#fff'}}>5 cycles (7.5 hours)</strong> — waking at the end of a cycle — beats 8 hours cut short mid-cycle. The endpoint matters more than the total.</p>
            ...
            {[
              ['1','Decide your wake-up time','Fix it first. Everything works backwards from here. Consistency matters more than the hour — your brain optimizes the cycle timing once it knows when to expect waking.','⏰ Pick one time, keep it'],
              ['2','Count back in 90-minute blocks','Subtract 90 minutes per cycle plus 15 minutes to fall asleep. For a 7am wake-up: 7:00 → 5:30 → 4:00 → 2:30 → 1:00 → 11:30pm. That last one is your ideal bedtime for 5 full cycles.','🧮 5 cycles = 7h 45min'],
              ['3','Train before you sleep','Anything you practice in the 2 hours before sleep gets priority processing during REM. A MemGenius session before bed means your brain actively rehearses those patterns overnight.','🧠 Learn → Sleep → Lock in'],
