       ...
       <div style={{ padding:'0 16px' }}>
         ...
         <div style={{ fontSize:14, color:'rgba(255,255,255,0.7)', lineHeight:1.8, display:'flex', flexDirection:'column', gap:14 }}>
           ...
           <div style={{ background:'#252525', borderRadius:14, padding:'16px', border:'1px solid rgba(0,180,216,0.2)' }}>
             ...
             <div style={{ fontSize:11, color:'rgba(255,255,255,0.25)', fontWeight:700, marginTop:8, fontStyle:'italic' }}>Sramek et al. — European Journal of Applied Physiology (2000)</div>
           </div>
           ...
           <div style={{ borderLeft:'3px solid #00b4d8', padding:'12px 14px', background:'rgba(0,180,216,0.05)', borderRadius:'0 10px 10px 0' }}>
         ...
         <div style={{ background:'#252525', borderRadius:16, padding:'16px', marginTop:16, border:'1px solid rgba(255,255,255,0.06)' }}>
           ...
           <div style={{ display:'flex', alignItems:'center', gap:12 }}>
             <img src="https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/sleep.png" alt="Sleep" style={{ width:56, height:56, borderRadius:10, objectFit:'cover', opacity:0.35 }} />
             <div>
