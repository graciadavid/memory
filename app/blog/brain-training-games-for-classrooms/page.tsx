  ...
  return (
    <main style={{ minHeight: "100dvh", background: CREAM, fontFamily: "var(--font-nunito), sans-serif", color: BROWN }}>
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <p style={{ fontSize: 15, lineHeight: 1.9, color: "#4A2C0A80", marginBottom: 24 }}>MemGenius is a free brain training platform with 16 games designed to train memory, reaction time, geography and logical thinking. Teachers can create a private group so students compete in real time from their phones with no login or app download required.</p>
