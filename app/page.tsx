...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: '100dvh', background: '#1A1A1A', padding: '16px 16px 100px' }}>
      ...
      {/* Play of the Week */}
      <a href="/blink" style={{ textDecoration: 'none', display: 'block', marginBottom: 12 }}>
        <div style={{ background: GREEN, borderRadius: 16, overflow: 'hidden', display: 'flex', alignItems: 'center', boxShadow: '0 4px 0 #1B5E20' }}>
          <div style={{ width: 100, height: 100, flexShrink: 0, background: 'rgba(0,0,0,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img src={`${BASE}/blink.png`} style={{ width: 56, height: 56, objectFit: 'contain' }} />
          </div>
          <div style={{ padding: '14px 16px', flex: 1 }}>
            <div style={{ fontSize: 11, fontWeight: 800, color: 'rgba(255,255,255,0.7)', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 4 }}>Play of the Week</div>
            <div style={{ fontSize: 17, fontWeight: 900, color: '#fff', marginBottom: 4 }}>Blink</div>
            <div style={{ fontSize: 12, fontWeight: 700, color: 'rgba(255,255,255,0.6)' }}>Remember the grid →</div>
          </div>
      ...
      {/* Most Played */}
      <a href="/pendulum" style={{ textDecoration: 'none', display: 'block', marginBottom: 12 }}>
        <div style={{ background: '#252525', borderRadius: 16, overflow: 'hidden', display: 'flex', alignItems: 'center' }}>
          <div style={{ width: 100, height: 100, flexShrink: 0, background: '#2a2a2a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img src={`${BASE}/pendulum.png`} style={{ width: 56, height: 56, objectFit: 'contain' }} />
          </div>
          <div style={{ padding: '14px 16px', flex: 1 }}>
            <div style={{ fontSize: 11, fontWeight: 800, color: 'rgba(255,255,255,0.4)', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 4 }}>Most Played</div>
            <div style={{ fontSize: 17, fontWeight: 900, color: '#fff', marginBottom: 4 }}>Pendulum</div>
            <div style={{ fontSize: 12, fontWeight: 700, color: 'rgba(255,255,255,0.4)' }}>Tap when vertical →</div>
          </div>
          <div style={{ paddingRight: 16, fontSize: 18, color: 'rgba(255,255,255,0.3)' }}>›</div>
        </div>
      </a>
      ...
      {profile && (
        <a href="/profile" style={{ textDecoration: 'none', display: 'block', marginBottom: 12 }}>
          <div style={{ background: '#252525', borderRadius: 16, overflow: 'hidden', display: 'flex', alignItems: 'center' }}>
            <div style={{ width: 100, height: 100, flexShrink: 0, background: '#2a2a2a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <div style={{ width: 48, height: 48, borderRadius: '50%', background: GREEN, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, fontWeight: 900, color: '#fff' }}>
