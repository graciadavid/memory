  ...
  return (
    <main style={{
      ...
      <p style={{ fontSize: 14, color: `${BROWN}70`, lineHeight: 1.8, marginBottom: 32 }}>
        MemGenius is a free daily brain training platform built around one idea: Train Your Brain. 14 games across 4 categories, world rankings, group competitions and daily streaks. No login required, no ads, free forever.
      </p>
