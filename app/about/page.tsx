...
const CATEGORIES = [
  ...
  { label: 'Logic', color: '#6A1B9A', games: 'Sudoku', desc: 'Challenge your reasoning and problem solving skills.' },
]
  ...
  return (
    <main style={{
      ...
      <p style={{ fontSize: 14, color: `${BROWN}70`, lineHeight: 1.8, marginBottom: 32 }}>
        MemGenius is a free daily brain training platform built around one idea: Train Your Brain. 10 games across 4 categories, world rankings, group competitions and daily streaks. No login required, no ads, free forever.
      </p>
