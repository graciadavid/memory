...
const CATEGORIES = [
  { label: 'Memory', color: '#E91E63', games: 'Memory · Digits · Simon Says · N-Back', desc: 'Train your ability to retain and recall information.' },
  { label: 'Agility', color: '#FF6F00', games: 'Stop · F1 Reaction · Pendulum · Ace', desc: 'Sharpen your reaction speed and timing precision.' },
  { label: 'Knowledge', color: '#1565C0', games: 'Flags · Higher or Lower · GeoShape', desc: 'Test and expand your world knowledge.' },
  { label: 'Logic', color: '#6A1B9A', games: 'Sudoku · Wordly · Mastermind · 2048', desc: 'Challenge your reasoning and problem solving skills.' },
]
  ...
  return (
    <main style={{
      ...
      <p style={{ fontSize: 14, color: `${BROWN}70`, lineHeight: 1.8, marginBottom: 32 }}>
        MemGenius is a free daily brain training platform built around one idea: Train Your Brain. 16 games across 4 categories, world rankings, group competitions and daily streaks. No login required, no ads, free forever.
      </p>
