...
export const metadata = {
  title: 'Terms of Service | MemGenius',
  description: 'Terms of service for MemGenius brain training games.',
}
  ...
  return (
    <main style={{ minHeight: '100dvh', background: CREAM, fontFamily: 'var(--font-nunito), sans-serif', maxWidth: 430, margin: '0 auto', padding: '32px 24px 100px', color: BROWN }}>
      ...
      {[
        ...
        { title: 'Advertising', text: 'MemGenius displays advertisements served by Google AdSense. These ads help us keep the service free. By using MemGenius you agree to the display of these advertisements. Google AdSense may use cookies to show you relevant ads based on your browsing history.' },
        ...
        { title: 'Disclaimers', text: 'MemGenius is provided as-is. We do not guarantee uninterrupted access or that the service will be error-free. Cognitive improvement claims are based on published research and individual results may vary.' },
