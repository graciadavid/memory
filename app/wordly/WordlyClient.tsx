...
export default function WordlyClient() {
  ...
  return (
    <main style={{ height:'calc(100dvh - 100px)', background:'#1C1C1E', fontFamily:'var(--font-nunito), sans-serif', maxWidth:430, margin:'0 auto', display:'flex', flexDirection:'column', padding:'4px 10px 4px', overflow:'hidden', justifyContent:'space-between' }}>
