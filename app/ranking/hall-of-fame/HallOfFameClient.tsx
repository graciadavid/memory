...
const CARDS = [
  ...
  { key: 'precision', label: 'Precision', phrase: 'The most precise player in the world is', color: '#4A148C', bg: 'linear-gradient(135deg, #EDE7F6, #D1C4E9)', border: '#4A148C40', icon: '⏱', result: (c: any) => `${(c.difference_ms/1000).toFixed(4)}s off` },
