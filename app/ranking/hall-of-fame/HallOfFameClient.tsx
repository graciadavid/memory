...
const CARDS = [
  ...
  { key: 'nback', label: 'N-Back', phrase: 'The best N-Back player in the world is', color: '#6A1B9A', bg: 'linear-gradient(135deg, #EDE7F6, #D1C4E9)', border: '#6A1B9A40', icon: 'https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/nback.png', result: (c: any) => `${c.level} correct` },
  ...
  { key: 'wordly', label: 'Wordly', phrase: 'The fastest Wordly solver in the world is', color: '#2E7D32', bg: 'linear-gradient(135deg, #E8F5E9, #C8E6C9)', border: '#2E7D3240', icon: 'https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/wordly.png', result: (c: any) => `${String(Math.floor(c.time_ms/60000)).padStart(2,'0')}:${String(Math.floor((c.time_ms%60000)/1000)).padStart(2,'0')} · ${c.attempts} tries` },
  { key: 'ace', label: 'Ace', phrase: 'The best Ace player in the world is', color: '#4CAF50', bg: 'linear-gradient(135deg, #E8F5E9, #C8E6C9)', border: '#4CAF5040', icon: 'https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/padel.png', result: (c: any) => `${c.level} aces` },
  { key: 'game2048', label: '2048', phrase: 'The best 2048 player in the world is', color: '#EDC22E', bg: 'linear-gradient(135deg, #FFF8E1, #FFF3CD)', border: '#EDC22E40', icon: 'https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/2048.png', result: (c: any) => `${c.best_tile} tile` },
  { key: 'mastermind', label: 'Mastermind', phrase: 'The fastest Mastermind solver in the world is', color: '#6A1B9A', bg: 'linear-gradient(135deg, #EDE7F6, #D1C4E9)', border: '#6A1B9A40', icon: 'https://bgmhfsccchktnknmqkuw.supabase.co/storage/v1/object/public/storage/mastermind.png', result: (c: any) => `${String(Math.floor(c.time_ms/60000)).padStart(2,'0')}:${String(Math.floor((c.time_ms%60000)/1000)).padStart(2,'0')} · ${c.attempts} tries` },
]
