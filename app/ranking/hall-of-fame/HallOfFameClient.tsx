...
const CARDS = [
  ...
  { key: 'versus', label: 'Higher or Lower', phrase: 'The best Higher or Lower player in the world is', color: '#C62828', bg: 'linear-gradient(135deg, #FFEBEE, #FFCDD2)', border: '#C6282840', icon: '⚔️', result: (c: any) => `${c.level} correct` },
]
