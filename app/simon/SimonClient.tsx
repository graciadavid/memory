...
const COLORS = [
 { id: 0, color: '#E53935', shadow: '#B71C1C', label: 'Red' },
 { id: 1, color: '#43A047', shadow: '#1B5E20', label: 'Green' },
 { id: 2, color: '#1E88E5', shadow: '#0D47A1', label: 'Blue' },
 { id: 3, color: '#FDD835', shadow: '#F57F17', label: 'Yellow' },
]
...
export default function SimonPage() {
 ...
 if (phase === 'rules') return (
   <main style={{ minHeight:'100dvh', background:'#0A0A0A', fontFamily:'var(--font-nunito), sans-serif', maxWidth:430, margin:'0 auto', display:'flex', flexDirection:'column', padding:'24px 24px 100px', overflowY:'auto' }}>
     ...
     <button onClick={startGame} style={{ width:'100%', padding:'20px', borderRadius:20, border:'none', background:'#7B1FA2', color:'#fff', fontSize:20, fontWeight:900, fontFamily:'inherit', cursor:'pointer', boxShadow:'0 8px 0 #4A148C80', marginTop:'auto' }}>
       Play →
     </button>
   </main>
 )
 ...
 if (phase === 'showing' || phase === 'input') return (
   <main style={{ minHeight:'100dvh', background:'#0A0A0A', fontFamily:'var(--font-nunito), sans-serif', maxWidth:430, margin:'0 auto', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:24, padding:'24px' }}>
 ...
 return (
   <main style={{ minHeight:'100dvh', background:bgResult, fontFamily:'var(--font-nunito), sans-serif', maxWidth:430, margin:'0 auto', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'32px 24px 100px', gap:20, overflowY:'auto' }}>
     ...
     <div style={{ display:'flex', gap:10, width:'100%' }}>
       ...
       <button onClick={()=>{setSaved(false);startGame()}} style={{ flex:2, padding:'16px', borderRadius:16, border:'none', background:'#7B1FA2', color:'#fff', fontSize:15, fontWeight:900, fontFamily:'inherit', cursor:'pointer', boxShadow:'0 5px 0 #4A148C80' }}>Play again →</button>
     </div>
   </main>
 )
}
