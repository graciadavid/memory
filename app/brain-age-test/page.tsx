  ...
  if (step === 'result' && brainAge) return (
    <main style={{ minHeight:'100dvh', background:'#1A1A1A', padding:'24px 16px 100px', fontFamily:'var(--font-nunito),sans-serif', maxWidth:430, margin:'0 auto' }}>
      <div style={{ textAlign:'center', marginBottom:32 }}>
        <div style={{ fontSize:13, fontWeight:800, color:'rgba(255,255,255,0.4)', letterSpacing:2, textTransform:'uppercase', marginBottom:16 }}>Your Result</div>
  ...
  if (step === 'tests') return (
    <main style={{ minHeight:'100dvh', background:'#1A1A1A', padding:'24px 16px 100px', fontFamily:'var(--font-nunito),sans-serif', maxWidth:430, margin:'0 auto' }}>
      ...
      <div style={{ textAlign:'center', marginBottom:28 }}>
        ...
        <div style={{ width:120, height:120, borderRadius:'50%', background:'linear-gradient(135deg, #8B6914, #C8960C, #FFD700)', margin:'0 auto', display:'flex', alignItems:'center', justifyContent:'center', boxShadow:'0 0 30px rgba(200,150,12,0.3)' }}>
        ...
        <div style={{ fontSize:12, fontWeight:700, color:'rgba(255,255,255,0.3)', marginTop:8 }}>{completedTests}/4 tests completed</div>
      </div>
        ...
        {TESTS.map((t, i) => {
          ...
          return (
            <a key={t.key} href={done ? undefined : t.href} style={{ textDecoration:'none' }}>
              <div style={{ background: active ? '#2a2a2a' : '#1e1e1e', borderRadius:16, padding:'14px 16px', display:'flex', alignItems:'center', gap:14, border: done ? `2px solid ${GREEN}` : active ? `2px solid ${GOLD}` : '2px solid rgba(255,255,255,0.05)', opacity: done ? 0.7 : 1 }}>
                ...
                <div style={{ flex:1 }}>
                  <div style={{ fontSize:11, fontWeight:800, color:'rgba(255,255,255,0.4)', letterSpacing:1, textTransform:'uppercase', marginBottom:2 }}>Step {t.step}</div>
                  <div style={{ fontSize:16, fontWeight:900, color:'#fff' }}>{t.label}</div>
                </div>
                {done
  ...
  return (
    <main style={{ minHeight:'100dvh', background:'#1A1A1A', padding:'24px 16px 100px', fontFamily:'var(--font-nunito),sans-serif', maxWidth:430, margin:'0 auto' }}>
      ...
      <div style={{ textAlign:'center', marginBottom:28 }}>
        ...
        <div style={{ fontSize:24, fontWeight:900, color:'#fff', lineHeight:1.2, marginBottom:6 }}>What is your Brain Age?</div>
      ...
      <button onClick={handleStart}
        style={{ width:'100%', padding:'18px', borderRadius:14, border:'none', background:GREEN, color:'#fff', fontSize:17, fontWeight:900, fontFamily:'var(--font-nunito),sans-serif', cursor:'pointer', boxShadow:'0 6px 0 #1B5E20', marginBottom:12 }}>
        Discover my Brain Age →
      </button>
      <div style={{ fontSize:12, color:'rgba(255,255,255,0.25)', fontWeight:700, textAlign:'center' }}>Free · No email · 4 minutes</div>
