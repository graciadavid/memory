...
export default function SudokuClient() {
  ...
  if (phase === 'playing' || phase === 'result') return (
    <main style={{ height:'100dvh', background:'#1C1C1E', fontFamily:'var(--font-nunito), sans-serif', maxWidth:430, margin:'0 auto', display:'flex', flexDirection:'column', padding:'8px 12px 80px', overflowY:'auto' }}>
