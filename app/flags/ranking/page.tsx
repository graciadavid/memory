...
import FlagsRankingClient from './FlagsRankingClient'

export const revalidate = 60

export default async function FlagsRankingPage() {
  ...
  return (
    <main style={{
      height: '100dvh',
      background: 'linear-gradient(180deg, #E0F2F1 0%, #FAF7F2 100%)',
      ...
      <div style={{ padding: '24px 16px 12px', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          <div style={{ fontSize: 26, fontWeight: 900, color: '#4A2C0A', letterSpacing: -1 }}>Flags Ranking</div>
        </div>
      ...
      <FlagsRankingClient scores={scores} />
