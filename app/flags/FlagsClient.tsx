...
const COUNTRIES = [
  ...
  { name: 'Venezuela', code: 've' }, { name: 'Ecuador', code: 'ec' }, { name: 'Bolivia', code: 'bo' },
  { name: 'Uruguay', code: 'uy' }, { name: 'Paraguay', code: 'py' }, { name: 'Cuba', code: 'cu' },
  ...
  { name: 'Singapore', code: 'sg' }, { name: 'Pakistan', code: 'pk' }, { name: 'Bangladesh', code: 'bd' },
  { name: 'Saudi Arabia', code: 'sa' }, { name: 'UAE', code: 'ae' }, { name: 'Israel', code: 'il' },
  { name: 'Iran', code: 'ir' }, { name: 'Iraq', code: 'iq' }, { name: 'Egypt', code: 'eg' },
  { name: 'Nigeria', code: 'ng' }, { name: 'South Africa', code: 'za' }, { name: 'Kenya', code: 'ke' },
  { name: 'Ethiopia', code: 'et' }, { name: 'Ghana', code: 'gh' }, { name: 'Morocco', code: 'ma' },
  { name: 'Algeria', code: 'dz' }, { name: 'Tunisia', code: 'tn' }, { name: 'Australia', code: 'au' },
  { name: 'New Zealand', code: 'nz' }, { name: 'Ireland', code: 'ie' }, { name: 'Croatia', code: 'hr' },
  { name: 'Serbia', code: 'rs' }, { name: 'Slovakia', code: 'sk' }, { name: 'Bulgaria', code: 'bg' },
  { name: 'Lithuania', code: 'lt' }, { name: 'Latvia', code: 'lv' }, { name: 'Estonia', code: 'ee' },
  { name: 'Iceland', code: 'is' }, { name: 'Luxembourg', code: 'lu' }, { name: 'Malta', code: 'mt' },
  { name: 'Cyprus', code: 'cy' }, { name: 'Jordan', code: 'jo' }, { name: 'Lebanon', code: 'lb' },
  { name: 'Syria', code: 'sy' }, { name: 'Kuwait', code: 'kw' }, { name: 'Qatar', code: 'qa' },
  { name: 'Bahrain', code: 'bh' }, { name: 'Oman', code: 'om' }, { name: 'Yemen', code: 'ye' },
  { name: 'Afghanistan', code: 'af' }, { name: 'Nepal', code: 'np' }, { name: 'Sri Lanka', code: 'lk' },
  { name: 'Myanmar', code: 'mm' }, { name: 'Cambodia', code: 'kh' }, { name: 'Mongolia', code: 'mn' },
  { name: 'Kazakhstan', code: 'kz' }, { name: 'Uzbekistan', code: 'uz' }, { name: 'Azerbaijan', code: 'az' },
  { name: 'Georgia', code: 'ge' }, { name: 'Armenia', code: 'am' }, { name: 'Tanzania', code: 'tz' },
  { name: 'Uganda', code: 'ug' }, { name: 'Cameroon', code: 'cm' }, { name: 'Ivory Coast', code: 'ci' },
  { name: 'Senegal', code: 'sn' }, { name: 'Mozambique', code: 'mz' }, { name: 'Zimbabwe', code: 'zw' },
  { name: 'Zambia', code: 'zm' }, { name: 'Angola', code: 'ao' }, { name: 'Sudan', code: 'sd' },
  { name: 'Libya', code: 'ly' }, { name: 'Somalia', code: 'so' }, { name: 'DR Congo', code: 'cd' },
  { name: 'Guatemala', code: 'gt' }, { name: 'Honduras', code: 'hn' }, { name: 'Costa Rica', code: 'cr' },
  { name: 'Panama', code: 'pa' }, { name: 'Dominican Republic', code: 'do' }, { name: 'Jamaica', code: 'jm' },
  { name: 'Trinidad', code: 'tt' }, { name: 'Haiti', code: 'ht' }, { name: 'El Salvador', code: 'sv' },
  { name: 'Nicaragua', code: 'ni' }, { name: 'Albania', code: 'al' }, { name: 'North Macedonia', code: 'mk' },
  { name: 'Bosnia', code: 'ba' }, { name: 'Slovenia', code: 'si' }, { name: 'Montenegro', code: 'me' },
  { name: 'Moldova', code: 'md' }, { name: 'Belarus', code: 'by' }, { name: 'Laos', code: 'la' },
  { name: 'Brunei', code: 'bn' }, { name: 'Taiwan', code: 'tw' }, { name: 'Papua New Guinea', code: 'pg' },
]
...
export default function FlagsClient() {
  ...
  const loadData = useCallback(async () => {
    ...
    setTop5(sorted.slice(0,5).map(([name,l]) => ({name, score:l+' flags'})))
  ...
  const endGame = useCallback(async (finalLevel: number) => {
   ...
   if (profile?.name && finalLevel > 0) { await supabase.from("flag_scores").insert({ player_name: profile.name, level: finalLevel }); supabase.rpc("update_streak", { p_player_name: profile.name }) }
 }, [profile?.name])
  ...
  if (phase === 'rules') return (
    <GameRulesScreen icon="flags.png" title="Flags" subtitle="Identify the country from its flag" worldRecord={worldRecord} myBest={myBest !== null ? myBest+' flags' : null} top5={top5} onPlay={startGame} />
  )
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:24, padding:'0 24px 80px' }}>
        {current && (
          <img
            ...
            style={{ width:240, height:'auto', borderRadius:8, boxShadow:'0 4px 20px rgba(0,0,0,0.5)' }}
          />
        )}
            ...
            return (
              <button key={opt.code} onClick={() => handleAnswer(opt)}
                style={{ width:'100%', padding:'16px', borderRadius:14, border:'none', fontFamily:'inherit', fontSize:16, fontWeight:800, cursor:'pointer', transition:'all 0.2s',
                  background: showCorrect ? '#2E7D32' : isWrong ? '#D32F2F' : '#252525',
